...
class GreateDiscountDetail extends StatefulWidget {
  @override
  _GreateDiscountDetailState createState() => _GreateDiscountDetailState();
}

class _GreateDiscountDetailState extends State<GreateDiscountDetail> {
